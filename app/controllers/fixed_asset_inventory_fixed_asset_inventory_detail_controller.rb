class FixedAssetInventoryFixedAssetInventoryDetailController < ApplicationController
  ...
  def index
    # binding.pry
    @fixed_asset_inventory_details = @fixed_asset_inventory.fixed_asset_inventory_details.order("fixed_asset_inventory_details.manage_unit_id, fixed_asset_inventory_details.manage_unit_id, fixed_asset_inventory_details.asset_no")
  ...
  def doing_index
    # binding.pry
    @fixed_asset_inventory_details = @fixed_asset_inventory.fixed_asset_inventory_details.where(manage_unit_id: current_user.unit_id).order("fixed_asset_inventory_details.manage_unit_id, fixed_asset_inventory_details.asset_no")
