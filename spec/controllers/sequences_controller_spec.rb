...
RSpec.describe SequencesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all sequences as @sequences" do
      ...
      expect(assigns(:sequences)).to eq([sequence])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested sequence as @sequence" do
      sequence = Sequence.create! valid_attributes
      get :show, {:id => sequence.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested sequence as @sequence" do
      sequence = Sequence.create! valid_attributes
      get :edit, {:id => sequence.to_param}, valid_session
      expect(assigns(:sequence)).to eq(sequence)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Sequence" do
        expect {
          post :create, {:sequence => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved sequence as @sequence" do
        post :create, {:sequence => invalid_attributes}, valid_session
        expect(assigns(:sequence)).to be_a_new(Sequence)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested sequence" do
        sequence = Sequence.create! valid_attributes
        put :update, {:id => sequence.to_param, :sequence => new_attributes}, valid_session
        sequence.reload
      ...
      it "assigns the requested sequence as @sequence" do
        sequence = Sequence.create! valid_attributes
        put :update, {:id => sequence.to_param, :sequence => valid_attributes}, valid_session
        expect(assigns(:sequence)).to eq(sequence)
      end
    ...
    context "with invalid params" do
      it "assigns the sequence as @sequence" do
        sequence = Sequence.create! valid_attributes
        put :update, {:id => sequence.to_param, :sequence => invalid_attributes}, valid_session
        expect(assigns(:sequence)).to eq(sequence)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested sequence" do
      sequence = Sequence.create! valid_attributes
      expect {
        delete :destroy, {:id => sequence.to_param}, valid_session
      }.to change(Sequence, :count).by(-1)
    end
